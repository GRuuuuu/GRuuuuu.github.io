...
api-int.gru   IN A 10.178.105.2
api.gru   IN A 10.178.105.2
*.apps.gru    IN A 10.178.105.2

;ocp cluster
bootstrap.gru   IN  A   10.178.105.4
master0.gru     IN  A   10.178.105.5
master1.gru     IN  A   10.178.105.6
master2.gru     IN  A   10.178.105.7

;ocp registry (only for restrict network)
registry.gru        IN  A  10.178.105.3
~~~
...
backend kubernetes_api
    balance roundrobin
    server bootstrap bootstrap.gru.hololy.net:6443 check
    server master0 master0.gru.hololy.net:6443 check
    server master1 master1.gru.hololy.net:6443 check
    server master2 master2.gru.hololy.net:6443 check
...
backend machine_config
    balance roundrobin
    server bootstrap bootstrap.gru.hololy.net:22623 check
    server master0 master0.gru.hololy.net:22623 check
    server master1 master1.gru.hololy.net:22623 check
    server master2 master2.gru.hololy.net:22623 check
...
backend router_https
    balance roundrobin
    server master0 master0.gru.hololy.net:443 check
    server master1 master1.gru.hololy.net:443 check
    server master2 master2.gru.hololy.net:443 check
...
backend router_http
    mode http
    balance roundrobin
    server master0 master0.gru.hololy.net:80 check
    server master1 master1.gru.hololy.net:80 check
    server master2 master2.gru.hololy.net:80 check
...
확인:  
~~~
$ curl -u admin:passw0rd -k https://registry.gru.hololy.net:5000/v2/_catalog
...
로그인하기:  
~~~
$ podman login -u admin -p passw0rd registry.gru.hololy.net:5000
Login Succeeded!
~~~
