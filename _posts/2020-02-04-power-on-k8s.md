...
크게 그림으로 보면 다음과 같습니다.  
![Picture1](https://user-images.githubusercontent.com/15958325/74113490-ca31a080-4be7-11ea-9f21-9515d7bca26c.png)  
  
즉 Docker Hub를 비롯한 컨테이너 레지스트리에 배포하고자 하는 **Node의 Architecture와 일치하는 이미지**가 있다면 해당 이미지를 pull 받아서 pod을 creating할 수 있습니다.  
...
위 테스트에서 사용했던 nginx는 Docker Hub에 다양한 Architecture를 위한 이미지가 있었고,   
x86과 Power PC용 빌드버전이 있었기 때문에 클러스터의 두 노드에 성공적으로 배포될 수 있었던것입니다.  
