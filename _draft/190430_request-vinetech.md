...
~~~json
          ...
          {
            "id": "id_vendor_feature",
            "name": "Vendor&Feature",
            "role": "dimension",
            "dataType": "string",
            "agg": {
              "id": "terms",
              "formula": "[lic_vendor_name]+ \" - \" +[lic_feature_name]",
              "selector": "buckets"
            }
          },
          {
...

          {
            "id": "id_usage_avg",
            "name": "# of Avg Used",
            "field": "id_usage_sum_raw",
            "role": "measure",
            "dataType": "numeric",
            "agg": {
              "id": "bucket_script",
              "formula":"[id_usage_sum_raw]/[id_sampling_count]"
            },
            "outputFormat": {
              "maximumFractionDigits": 2
            }
          },
          {
            ...
            "agg": {
              ...
              "internalFormula": {
                ...
                "args": [
                  {
                    "when": "[minute_of_day] >=0 && [minute_of_day] < 60",
                    "then": " 0 "
                  },
                  {
                    "when": "[minute_of_day] >=60 && [minute_of_day] < 120",
                    "then": " 1 "
                  },
                  {
                    "when": "[minute_of_day] >=120 && [minute_of_day] < 180",
                    "then": " 2 "
                  },
                  {
                    "when": "[minute_of_day] >=180 && [minute_of_day] < 240",
                    "then": " 3 "
                  },
                  {
                    "when": "[minute_of_day] >=240 && [minute_of_day] < 300",
                    "then": " 4 "
                  },
                  {
                    "when": "[minute_of_day] >=300 && [minute_of_day] < 360",
                    "then": " 5 "
                  },
                  {
                    "when": "[minute_of_day] >=360 && [minute_of_day] < 420",
                    "then": " 6 "
                  },
                  {
                    "when": "[minute_of_day] >=420 && [minute_of_day] < 480",
                    "then": " 7 "
                  },
                  {
                    "when": "[minute_of_day] >=480 && [minute_of_day] < 540",
                    "then": " 8 "
                  },
                  {
                    "when": "[minute_of_day] >=540 && [minute_of_day] < 600",
                    "then": " 9 "
                  },
                  {
                    "when": "[minute_of_day] >=600 && [minute_of_day] < 660",
                    "then": " 10 "
                  },
                  {
                    "when": "[minute_of_day] >=660 && [minute_of_day] < 720",
                    "then": " 11 "
                  },
                  {
                    "when": "[minute_of_day] >=720 && [minute_of_day] < 780",
                    "then": " 12 "
                  },
                  {
                    "when": "[minute_of_day] >=780 && [minute_of_day] < 840",
                    "then": " 13 "
                  },
                  {
                    "when": "[minute_of_day] >=840 && [minute_of_day] < 900",
                    "then": " 14 "
                  },
                  {
                    "when": "[minute_of_day] >=900 && [minute_of_day] < 960",
                    "then": " 15 "
                  },
                  {
                    "when": "[minute_of_day] >=960 && [minute_of_day] < 1020",
                    "then": " 16 "
                  },
                  {
                    "when": "[minute_of_day] >=1020 && [minute_of_day] < 1080",
                    "then": " 17 "
                  },
                  {
                    "when": "[minute_of_day] >=1080 && [minute_of_day] < 1140",
                    "then": " 18 "
                  },
                  {
                    "when": "[minute_of_day] >=1140 && [minute_of_day] < 1200",
                    "then": " 19 "
                  },
                  {
                    "when": "[minute_of_day] >=1200 && [minute_of_day] < 1260",
                    "then": " 20 "
                  },
                  {
                    "when": "[minute_of_day] >=1260 && [minute_of_day] < 1320",
                    "then": " 21 "
                  },
                  {
                    "when": "[minute_of_day] >=1320 && [minute_of_day] < 1380",
                    "then": " 22 "
                  },
                  {
                    "when": "[minute_of_day] >=1380 && [minute_of_day] < 1440",
                    "then": " 23 "
                  },
                  {
                    "default": " 0 "
          ...
          },
          {
            ...
            "agg": {
              ...
              "internalFormula": {
                ...
                "args": [
                  {
                    "when": "[day_of_week] >= 1 && [day_of_week] <= 5 && [minute_of_day] >=[parameters.businessHours.startMinute] && [minute_of_day] < [parameters.businessHours.endMinute]",
                    "then": " Y "
                  },
                  {
                    "default": " N "
